...
const { successEmbed, errorEmbed, warningEmbed, createEmbed, COLORS } = require('../../utils/embeds');
const { getUserData, sendLog, modEmbed } = require('../../utils/helpers');
const { modEmbed: modEmbedUtil } = require('../../utils/embeds');
  ...
  async execute(interaction) {
    ...
    try {
      ...
      await sendLog(interaction.client, interaction.guild,
        modEmbedUtil('warn', target.user, interaction.user, reason, {
